...
zu 5 Kategorien bewerten zu lassen. Durch die Kombination der Antworten des Anwenders mit dem hinterlegtem 
...
Expertenmeinungen statt. Die notwendigen Nutzerinformationen werden im Rahmen eines Fragebogens erhoben, welcher sich 
...
Im nächsten Schritt beantwortet der Nutzer Fragen zu Datenverfügbarkeiten und Datenqualität, welche für die Bewertung
...
| Interpretierbarkeit                       | Beschreibt die Interpretierbarkeit und Transparenz der erstellen Prognose. Es gibt ML-Ansätze, wie bspw. klassische neuronale Netze, welche als Black Box fungieren und damit nur schwer zu interpretieren sind.                                                                   | WBP               |
...
| Interpretierbarkeit                       | Beschreibt die Interpretierbarkeit und Transparenz der Modelle mit Hinsicht auf erkannte Fehler oder Anomalien. Es gibt ML-Ansätze, wie bspw. klassische Autoencoder, welche als Black Box fungieren und damit nicht ohne Zusatzaufwand interpretierbar sind.                      | InHAST            |
...
| Interpretierbarkeit                       | Beschreibt die Interpretierbarkeit und Transparenz der Modelle mit Hinsicht auf erkannte Leckagen. Es gibt ML-Ansätze, welche als Black Box fungieren und nur schwer zu interpretieren sind. Andere Modelle benötigen dafür aber oftmals mehr Daten oder sind schwerer anzuwenden. | InRN |
...
| Interpretierbarkeit                       | Beschreibt die Interpretierbarkeit und Transparenz der Modelle mit Hinsicht auf die getroffenen Entscheidungen. Es gibt ML-Ansätze, welche als Black Box fungieren und nur schwer zu interpretieren sind.                                                                          | BeWN |
| Kundenkomfort                             | Beschreibt zu welchem Grad Kundenkomfort bei der Erstellung von Netzbetriebsstrategien berücksichtigt wird.                                                                                                                                                                        | BeWN |
...
| Interpretierbarkeit                       | Beschreibt die Interpretierbarkeit und Transparenz der Modelle mit Hinsicht auf die getroffenen Entscheidungen. Es gibt ML-Ansätze, welche als Black Box fungieren und nur schwer zu interpretieren sind.                                                                          | BeHAST |
...
Das vordefinierte Kategorieranking wurde im Projekt auf Basis einer Expertenumfrage ermittelt, bei welcher Experten
des Fraunhofer IEE, Fraunhofer IBP und der AGFW die 5 ML Use Case Kategorien hinsichtlich jedes Kriteriums mit einer Zahl
von 1 bis 5 eingeschätzt haben. Die Mittelwerte Experteneinschätzungen für jede Kategorie und jedes Kriterium ergeben die das 
...
In diesem Fall könnten Use Cases, welche diese Daten benötigen, nicht umgesetzt werden. 
Um solche Fälle abzudecken, sind für jeden Use Case Bedingungen definiert, welche zur Nichtumsetzbarkeit führen. 
...
Analog zur Bestimmung des Nutzens von Kategorien werden hier die vom Nutzer vorgenommenen Gewichtungen der Kriterien mit 
...
In diesem Fall erhöht sich der Datenerhebungsaufwand für alle Use Cases, welche diese Daten benötigen. 
...
Für jedes Aufwandskriterium wird der Mittelwert aller für den jeweiligen Use Case relevanten Fragen, welche diesem Kriterium zugewiesen sind, gebildet
...
Die Färbung der Punkte gibt das Kategorierisiko wieder. Nach der Visualisierung der Kategorien werden analoge Grafiken für die Use Cases 
...
| Spitzenlastreduzierung                                                                      | Dieser Use Case nutzt einen Reinforcement Learning Ansatz, welcher auf Basis eines Netzmodells, einer thermodynamischen Modellierung der Gebäude im Fernwärmenetz und eines agentenbasierten Nutzerkomfortmodells eine optimale Strategie für die Reduktion von Spitzenlasten ermittelt.                                                                                                                                                                                              | [Link](https://doi.org/10.1016/j.engappai.202)                                                                       | BeWN     |
