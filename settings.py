...
Attributes:
    ...
    possible_condition_types (Set[str]): list of strings describing all possible condition types.
...
short_category_names: Dict[str, str] = {"Wärmebedarfsprognose": "WBP", "Instandhaltung Hausstationen": "InHAST",
                                        "Instandhaltung Rohrnetz": "InRN", "Betriebsstrategien Wärmenetz": "BeWN",
                                        "Betriebsstrategien Hausstationen": "BeHAST"}
risk_colors: Dict[int, str] = {5: "#A52A2A", 4: "#D2691E", 3: "#FFA500", 2: "#FFD700", 1: "#F0FFFF"}
global_criteria: List[str] = ["Kostenaufwand", "Zeitaufwand", "Personalaufwand", "Versorgungssicherheit",
                              "Umweltauswirkungen / Dekarbonisierung", "Energieeffizienz", "Automatisierungsgrad"]
global_criteria_description: Dict[str, str] = {
    "Kostenaufwand": "Voraussichtlicher Aufwand in Form von Kosten für die gesamte Use Case "
...
category_criteria: Dict[str, List[str]] = {category_names[0]: ["Genauigkeit", "Interpretierbarkeit", "Kundenkomfort"],
                                           category_names[1]: ["Fehlererkennung", "Identifikation von Ursachen",
                                                               "Wenige Fehlalarme",
                                                               "Fehlerfrüherkennung", "Interpretierbarkeit"],
                                           category_names[2]: ["Erkennen von vorhandenen Leckagen",
                                                               "Ortung von Leckagen",
                                                               "Vorbeugung von Fehlern", "Wenige Fehlalarme",
                                                               "Interpretierbarkeit"],
                                           category_names[3]: ["Energieeffizienz", "Interpretierbarkeit",
                                                               "Kundenkomfort"],
                                           category_names[4]: ["Reduktion der Rücklauftemperatur",
                                                               "Interpretierbarkeit",
                                                               "Kundenkomfort"]
                                           }
category_criteria_description: Dict[str, Dict[str, str]] = {
    category_names[0]: {"Genauigkeit": "Beschreibt wie gering der Vorhersagefehler"
...
question_types: Set[str] = {"Preference", "Specification", "Potential", "Effort", "Risk"}
...
min_substations_for_clustering: int = 30
max_pipeline_depth: int = 2  # According to https://www.iea-dhc.org/fileadmin/documents/Annex_IV/aiv4.pdf
